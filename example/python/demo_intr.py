...
reg_B.add_intr_field(name='field0',bit=1,init_value=0, mask_init_value=1,description='fied0, software read only.' ,offset=0)
...
reg_D = InterruptRegister(name='intr_reg_mask', description='reg0',reg_type=IntrMask)

reg_D.add_intr_field(name='field0',bit=1,init_value=0, mask_init_value=1,description='fied0, software read only.' ,offset=0)
reg_D.add_intr_field(name='field1',bit=2,init_value=0,description='fied1, software write only.',offset=1)
reg_D.add_intr_field(name='field2',bit=1,init_value=0,description='fied2, software read write.',offset=3)
reg_D.add_intr_field(name='field3',bit=3,init_value=0,description='fied3, hardware read only.' ,offset=6)

...
reg_B = Register(name='internal_reg_1',bit=32, description='reg0',reg_type=Normal, parity=True, rst_domain='rst_domain_b')
...
reg_B.add(Field(name='field4',bit=2,sw_access=WriteReadSet,hw_access=Null, init_value=1,description='fied3, WriteReadSet.' ),offset=8)
...
reg_C = Register(name='internal_reg_2',bit=32, description='reg0',reg_type=Normal, parity=True, rst_domain='rst_domain_c')
...
reg_ext_B = Register(name='external_reg_1',bit=32, description='reg0',reg_type=Normal, parity=False, rst_domain='rst_domain_b_ext')
...
reg_ext_C = Register(name='external_reg_1',bit=32, description='reg0',reg_type=Normal, parity=True, rst_domain='rst_domain_c_ext')

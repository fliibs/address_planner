...
reg_bank_B = RegSpace(name='reg_bank_intr_test',size=8*KB,description='reg_bank_B,contain many regs.',bus_width=16,software_interface='apb4')

reg_B = InterruptRegister(name='intr_reg_1', description='reg0',reg_type=Intr, parity=True, rst_domain='rst_intr_a')
...
reg_D = InterruptRegister(name='intr_reg_2', description='reg0',reg_type=IntrMask, parity=True, rst_domain='rst_intr_b')

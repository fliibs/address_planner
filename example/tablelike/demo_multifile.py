...
RS_0 = import_inst('example/tablelike/ip0/ip_0_0/regspace_demo_0.py','RS_0')
RS_1 = import_inst('example/tablelike/ip1/regspace_demo_1.py','RS_1')
RS_2 = import_inst('example/tablelike/ip1/regspace_demo_1.py','RS_2')

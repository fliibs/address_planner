...
'''
RegCfg = '''
reg_{cnt}.add({Field}Field(name='{name}',bit={bit},sw_access={SoftwareAccess}, hw_access={HardwareAccess},init_value={initValue},description="{description}" ),offset={offset})
'''
ADD= '''

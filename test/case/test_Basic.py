...
def test_Register():
    ...
    reg_B.add_incr(ExternalField(name='field3',bit=1,sw_access=ReadWrite,hw_access=ReadOnly,description='fied0,read only.'))
    reg_B.add_incr(ExternalField(name='field4',bit=1,sw_access=ReadWrite,hw_access=WriteOnly,description='fied0,write only.'))
    reg_B.add_incr(ExternalField(name='field5',bit=1,sw_access=ReadWrite,hw_access=ReadWrite,description='fied0,read write.'))

...
def test_regbank():
    ...
    reg_B.add(FieldReadOnly(name='field3',bit=1,description='fied0,read only.'),offset=7)
    reg_B.add(FieldWriteOnly(name='field4',bit=1,description='fied0,write only.'),offset=9)
    reg_B.add(FieldReadWrite(name='field5',bit=1,description='fied0,read write.'),offset=11)
